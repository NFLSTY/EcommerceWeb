...
<div class="container">
    <div class="profile-header">
        <div class="profile-pic">
            <img src="<?= $user['profile_image'] ?: 'https://via.placeholder.com/120' ?>" alt="Profile Picture" id="profile-image">
        ...
        <div class="profile-info">
            ...
            <a href="edit-profile.php"><button class="edit-profile-btn">Edit Profile</button></a>
        </div>
    </div>
    ...
    <div class="profile-content">
        <div class="profile-sidebar">
                <ul class="sidebar-menu">
                    <li><a href="#" class="active" data-tab="profile-tab"><i class="fas fa-user"></i> Personal Information</a></li>
        ...
        <div class="profile-main">
            ...
            <div class="form-group">
                <label>Phone</label>
                <input class="form-control" type="text" value="<?= htmlspecialchars($user['phone'] ?? '-') ?>" readonly>
            </div>
        </div>
    </div>
</div>
