        ...
        @if(count($cart) > 0)
                            ...
                            <tr>
                                <td>
                                    <img src="{{ $item['foto'] && file_exists(public_path('storage/' . $item['foto'])) ? asset('storage/' . $item['foto']) : 'https://via.placeholder.com/80x80/6c757d/ffffff?text=' . substr($item['nama'], 0, 1) }}"
                                        alt="{{ $item['nama'] }}" style="width: 80px; height: 80px; object-fit: cover;">
                                </td>
                                <td>{{ $item['nama'] }}</td>
                                ...
                                <td>
                                    <form action="{{ route('cart.update') }}" method="POST" class="d-flex align-items-center">
                                        ...
                                        <input type="number" name="qty" value="{{ $item['qty'] }}" min="1" class="form-control me-2"
                                            style="width: 80px;">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-6 text-end">
                    ...
                    <a href="{{ url('/purchase-history') }}" class="btn btn-primary">
