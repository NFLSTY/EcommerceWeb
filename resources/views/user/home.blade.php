                ...
                <div id="carouselBanner" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="{{ asset('images/banner/Banner-Slider-Home-banner-1742015338.jpg') }}"
                                class="d-block w-100" alt="Banner 1">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/banner/Banner-Slider-Home-Casing-CG-Cinema-Athos-1744711639.jpg') }}"
                                class="d-block w-100" alt="Banner 2">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/banner/Banner-Slider-Home-Cooler-Anima-1745993994.jpg') }}"
                                class="d-block w-100" alt="Banner 3">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/banner/Banner-Slider-Home-Cooler-galahad-1746179641.jpg') }}"
                                class="d-block w-100" alt="Banner 4">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/banner/Banner-Slider-Home-PSU-1stplayer-ngdp-1746154754.jpg') }}"
                                class="d-block w-100" alt="Banner 5">
                        </div>
                        <div class="carousel-item">
                            <img src="{{ asset('images/banner/Banner-Slider-Home-PSU-bequiet-pure-power-1744711720.jpg') }}"
